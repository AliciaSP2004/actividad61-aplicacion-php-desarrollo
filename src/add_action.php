...
if (isset($_POST['inserta'])) {
    ...
    $debilidad   = isset($_POST['debilidad']) ? $mysqli->real_escape_string($_POST['debilidad']) : '';
    ...
    // Inserción
    $sql = "INSERT INTO pokemons (nº_pokedex, nombre, tipo, region, generacion, descripcion, habilidad, debilidad) 
            VALUES ('$n_pokedex', '$nombre', '$tipo', '$region', '$generacion', '$descripcion', '$habilidad', '$debilidad')";
